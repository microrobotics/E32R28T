//In this example screen is rotated - see line 18
...
void setup() {
  ...
  tft.init();
  tft.setRotation(3);  // Rotate screen: 0=0°, 1=90°, 2=180°, 3=270°
  ...
  ts.begin(touchSPI);
  ts.setRotation(3);  // Match touch rotation to screen rotation
}
